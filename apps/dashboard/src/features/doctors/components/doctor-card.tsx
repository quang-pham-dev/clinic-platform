  ...
  return (
    <Link to="/doctors/$doctorId/slots" params={{ doctorId: doctor.id }}>
      <motion.div
        ...
        className="group rounded-xl border border-gray-800 bg-gray-900/80 p-6 hover:border-teal-500/30 hover:bg-gray-800/50 transition-all hover:shadow-lg hover:shadow-teal-500/5 flex flex-col cursor-pointer"
      >
