...
describe('BookingsService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        BookingStateMachine, // real one to test integration or mock
  ...
  describe('findOne', () => {
    ...
    it('should throw ForbiddenException if patient accesses other patient booking', async () => {
      mockRepo.findOne.mockResolvedValueOnce({ id: 'id1', patientId: 'pat2' });
      await expect(
        service.findOne('id', {
          sub: 'pat1',
          email: 'e@e.com',
    ...
    it('should return appointment if patient is owner', async () => {
      mockRepo.findOne.mockResolvedValueOnce({ id: 'id1', patientId: 'pat1' });
